      ...
      <td>
        <div className="flex items-center gap-2">
          <Link href={`/list/teachers/${item.id}`}>
            <button className="w-7 h-7 justify-center items-center flex rounded-full bg-bgSky">
              <Image src="/view.png" height={16} width={16} alt="" />
            </button>
          </Link>
          {role === "admin" && (
            // <button className="w-7 h-7 justify-center items-center flex rounded-full bg-bgPurple">
